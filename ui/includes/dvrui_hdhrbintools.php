...
class DVRUI_HDHRbintools {
	...
	public function __construct() {
		...
		if (file_exists(DVRUI_Vars::DVR_pkgPath . "/" . DVRUI_Vars::DVR_bin)) {
			error_log("Setting hdhr to [". DVRUI_Vars::DVR_pkgPath . "/" . DVRUI_Vars::DVR_bin . "]");
			$this->hdhr_bin = DVRUI_Vars::DVR_pkgPath . "/" . DVRUI_Vars::DVR_bin;
		} elseif (file_exists($rpath . "/" . DVRUI_Vars::DVR_bin)) {
			error_log("Setting hdhr to [". $rpath . "/" . DVRUI_Vars::DVR_bin ."]");
			$this->hdhr_bin = $rpath . "/" . DVRUI_Vars::DVR_bin;
		}
	}
